...
const en = {
  ...
  "settings.trustedContact": "Trusted Contact",
  "settings.securityLogin": "Security & Login",
...
const nl: Record<keyof typeof en, string> = {
  ...
  "settings.parentalControls": "Ouderlijk toezicht",
  "settings.trustedContact": "Vertrouwd contact",
  "settings.securityLogin": "Beveiliging en inloggen",
